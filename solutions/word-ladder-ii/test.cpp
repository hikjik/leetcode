...
TEST_CASE("Simple") {
  {
    ...
    std::string end_word = "hit";
    std::vector<std::string> word_list{"hit"};
    std::vector<std::vector<std::string>> expected{{"hit"}};
    auto actual = Solution::findLadders(begin_word, end_word, word_list);
  ...
  }
  {
    ...
    std::vector<std::string> word_list{"ted", "tex", "red", "tax",
                                       "tad", "den", "rex", "pee"};
    std::vector<std::vector<std::string>> expected{
        {"red", "rex", "tex", "tax"},
        {"red", "ted", "tad", "tax"},
  ...
  {
    std::string begin_word = "aaaaa";
    std::string end_word = "ggggg";
    ...
    REQUIRE(paths == Solution::findLadders(begin_word, end_word, word_list));
  }
}
